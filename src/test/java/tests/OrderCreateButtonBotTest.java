...
public class OrderCreateButtonBotTest extends BaseTest {
    ...
    public OrderCreateButtonBotTest(String name, String surname, String addressFrom, String subway, String phoneNumber, String dateDelivery, String rentalPeriod, String colorScooter, String comment) {
        this.name = name;
    ...
    @Test
    public void orderPositiveTestBot() {
        OrderPageScooter objOrderPageScooter = new OrderPageScooter(driver);
        objOrderPageScooter.setAcceptCookieButton();
        objOrderPageScooter.scrollToButtonBotOrder();
        objOrderPageScooter.clickButtonBotOrder();
