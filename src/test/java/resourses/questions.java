...
public class questions {
    ...
    public static final By ITEM_ANSWER_0 = By.xpath(".//*[@aria-controls='accordion__panel-0']");
    ...
    public static final By ITEM_ANSWER_1 = By.xpath(".//*[@aria-controls='accordion__panel-1']");
    ...
    public static final By ITEM_ANSWER_2 = By.xpath(".//*[@aria-controls='accordion__panel-2']");
    ...
    public static final By ITEM_ANSWER_3 = By.xpath(".//*[@aria-controls='accordion__panel-3']");
    ...
    public static final By ITEM_ANSWER_4 = By.xpath(".//*[@aria-controls='accordion__panel-4']");
    ...
    public static final By ITEM_ANSWER_5 = By.xpath(".//*[@aria-controls='accordion__panel-5']");
    ...
    public static final By ITEM_ANSWER_6 = By.xpath(".//*[@aria-controls='accordion__panel-6']");
    ...
    public static final By ITEM_ANSWER_7 = By.xpath(".//*[@aria-controls='accordion__panel-7']");
